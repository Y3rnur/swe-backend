...
def _validate_status_transition(
    ...
    valid_transitions = {
        ...
        ComplaintStatus.RESOLVED: set(),  # Resolved complaints cannot be changed
    }
...
async def create_complaint(
    ...
    # Verify sales rep and manager are supplier staff for the order's supplier
...
@router.get("", response_model=dict)  # Will be PaginationResponse[ComplaintResponse]
